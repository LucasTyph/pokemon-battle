	...
	public class solveTurn extends Event{
		...
		public void action() {
			...
			if (t1.actions[0] == 1 && t2.actions[0] != 1) {
				...
				int dmg = Damage.dano(t1.party[t1.atual].attack, t2.party[t2.atual].defense, t1.party[t1.atual].a[t1.actions[1]].power, t1.party[t1.atual].a[t1.actions[1]].tipohit, t1.party[t1.atual].a[t1.actions[1]].tipodoataque, t1.party[t1.atual].tipo, t2.party[t2.atual].tipo);
			...
			if (t2.actions[0] == 1 && t1.actions[0] != 1) {
				...
				int dmg = Damage.dano(t2.party[t2.atual].attack, t1.party[t1.atual].defense, t2.party[t2.atual].a[t2.actions[1]].power, t2.party[t2.atual].a[t2.actions[1]].tipohit, t2.party[t2.atual].a[t2.actions[1]].tipodoataque, t2.party[t2.atual].tipo, t1.party[t1.atual].tipo );
			...
			if (t1.actions[0] == 1 && t2.actions[0] == 1) {
				if (t1.party[t1.atual].a[t1.actions[1]].priority > t2.party[t2.atual].a[t2.actions[1]].priority) {
					...
					if (t2.party[t2.atual].hitpoints > 0) {
						System.out.println(t2.party[t2.atual].name + " usou " + t2.party[t2.atual].a[t2.actions[1]].name + "!");
						int dmg2 = Damage.dano(t2.party[t2.atual].attack, t1.party[t1.atual].defense, t2.party[t2.atual].a[t2.actions[1]].power, t2.party[t2.atual].a[t2.actions[1]].tipohit, t2.party[t2.atual].a[t2.actions[1]].tipodoataque, t2.party[t2.atual].tipo, t1.party[t1.atual].tipo);
		...
		public void action() {
			...
			if (t1.actions[0] == 3) {  //caso em que o treinador joga uma pokebola
				...
				if (success) {
					...
					int dmg = Damage.dano(wild.attack, t1.party[t1.atual].defense, wild.a[wildAction].power, wild.a[wildAction].tipohit, wild.a[wildAction].tipodoataque, wild.tipo, t1.party[t1.atual].tipo);
					t1.party[t1.atual].hitpoints -= dmg;
					System.out.println("Causou " + dmg + " de dano!");
					if (t1.party[t1.atual].hitpoints <= 0) {
						System.out.println(t1.party[t1.atual].name + " fainted!");
				...
				if (t1.party[t1.atual].a[t1.actions[1]].priority > wild.a[wildAction].priority) {
					System.out.println(t1.party[t1.atual].name + " usou " + t1.party[t1.atual].a[t1.actions[1]].name + "!");
					int dmg = Damage.dano(t1.party[t1.atual].attack, wild.defense, t1.party[t1.atual].a[t1.actions[1]].power, t1.party[t1.atual].a[t1.actions[1]].tipohit, t1.party[t1.atual].a[t1.actions[1]].tipodoataque, t1.party[t1.atual].tipo, wild.tipo);
					wild.hitpoints -= dmg;
					System.out.println("Causou " + dmg + " de dano!");
					if (wild.hitpoints > 0) {
						System.out.println(wild.name + " usou " + wild.a[wildAction].name + "!");
						int dmg2 = Damage.dano(wild.attack, t1.party[t1.atual].defense, wild.a[wildAction].power, wild.a[wildAction].tipohit, wild.a[wildAction].tipodoataque, wild.tipo, t1.party[t1.atual].tipo);
						t1.party[t1.atual].hitpoints -= dmg2;
						System.out.println("Causou " + dmg2 + " de dano!");
						if (t1.party[t1.atual].hitpoints <= 0) {
							System.out.println(t1.party[t1.atual].name + " fainted!");
